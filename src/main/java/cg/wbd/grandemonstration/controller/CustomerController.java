...
import cg.wbd.grandemonstration.aspect.DuplicateEmailException;
...
public class CustomerController {
    ...
    @PostMapping("/create")
    public ModelAndView createCustomer(@ModelAttribute("customer") Customer customer, Model model) throws DuplicateEmailException {
        customerService.save(customer);
        model.addAttribute("customer", new Customer());
